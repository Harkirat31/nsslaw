      ...
      <div className="text-white absolute top-0 lg:px-20 w-full h-[80vh] lg:h-lvh">
        <div className="flex flex-row items-center justify-center h-full">
          <div className="flex flex-col p-4 lg:p-1">
            <h1 className="text-yellow-500 font-bold">Welcome to our Site</h1>
            <h1 className=" mt-2 md:w-[500px]  font-extrabold text-2xl lg:text-5xl">Protecting Your Legal Interests in GTA</h1>
            <div className="flex flex-row border-yellow-500 border-2 p-2 mt-4 w-fit font-bold items-center"><Link href={"/#services"} >{`Practice Area `} </Link><FaArrowRight className="ml-2" /></div>
          </div>
        </div>
